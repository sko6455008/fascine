        ...
        <div id="welcome" class="rev_slider fullscreenbanner" style="display:none;" data-version="5.4.3.1">
            <ul>
                ...
                <li data-index="rs-901" data-transition="fade" data-slotamount="default" data-hideafterloop="0"
                    ...
                    data-thumb="<?php echo $theme_uri; ?>/images/main-slider/slide1.jpeg" data-rotate="0"
                    ...
                    data-description="">
                    <!-- MAIN IMAGE -->
                    <img src="<?php echo $theme_uri; ?>/images/main-slider/slide1.jpeg" alt=""
                        data-lazyload="<?php echo $theme_uri; ?>/images/main-slider/slide1.jpeg"
                    ...
                    white-space: normal; 
                    color:#541f5c;
                    border-width:0px; font-family: 'Great Vibes', cursive;">Concept</div>
                    ...
                    border-width:0px;">
                        <div style="text-transform:uppercase;">
                            <span class="site-text-primary"
                                style="font-family: 'Noto Sans JP', sans-serif; color:#F5F5F5; text-shadow: 0 2px 4px rgba(0,0,0,0.3);">特別なひとときを</span>
                        </div>
                    ...
                    <div class="tp-caption  tp-resizeme" id="slide-901-layer-5" data-x="['left','left','left','left']"
                        ...
                        <span
                            style="font-family: 'Noto Sans JP', sans-serif; color:#F5F5F5; text-shadow: 0 2px 4px rgba(0,0,0,0.3);">
                            経験豊富なネイリストが、あなたに合わせた、品のある洗練されたデザインをご提案します。
                        </span>
                    </div>
                ...
                <li data-index="rs-902" data-transition="fade" data-slotamount="default" data-hideafterloop="0"
                    data-hideslideonmobile="off" data-easein="default" data-easeout="default" data-masterspeed="default"
                    data-thumb="<?php echo $theme_uri; ?>/images/main-slider/slide2.jpeg" data-rotate="0"
                    data-fstransition="fade" data-fsmasterspeed="300" data-fsslotamount="7" data-saveperformance="off"
                    data-title="Slide Title" data-param1="Additional Text" data-description="">
                    <!-- MAIN IMAGE -->
                    <img src="<?php echo $theme_uri; ?>/images/main-slider/slide2.jpeg" alt=""
                        data-lazyload="<?php echo $theme_uri; ?>/images/main-slider/slide2.jpeg"
                        data-bgposition="center center" data-bgfit="cover" data-bgparallax="4" class="rev-slidebg"
                        data-no-retina>
                    ...
                    <div class="tp-caption tp-resizeme" id="slide-902-layer-3" data-x="['left','left','left','left']"
                        ...
                        style="z-index: 13; white-space: normal; color:#541f5c; border-width:0px; font-family: 'Great Vibes', cursive;">
                        Extensive Menu
                    </div>
                    ...
                    <div class="tp-caption tp-resizeme" id="slide-902-layer-4" data-x="['left','left','left','left']"
                        ...
                        <div style="text-transform:uppercase;">
                            <span class="site-text-primary"
                                style="font-family: 'Noto Sans JP', sans-serif; color:#F5F5F5; text-shadow: 0 2px 4px rgba(0,0,0,0.3);">豊富なメニュー</span>
                        </div>
                    </div>
