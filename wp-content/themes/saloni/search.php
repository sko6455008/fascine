        ...
        <div class="wt-bnr-inr-entry">
            <div class="banner-title-outer text-center">
                <div class="banner-title-name">
                    <h2 class="wt-title">
                        <?php printf(esc_html__('Search Results for: %s', 'saloni'), get_search_query()); ?>
                    </h2>
                </div>
            </div>
            <!-- BREADCRUMB ROW -->
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-md-12">
                ...
                <?php else: ?>
                    <div class="no-results text-center p-a30">
                        <h2>
                            <?php esc_html_e('Nothing Found', 'saloni'); ?>
                        </h2>
                        <p>
                            <?php esc_html_e('Sorry, but nothing matched your search terms. Please try again with some different keywords.', 'saloni'); ?>
                        </p>
                        <?php get_search_form(); ?>
                    </div>
                <?php endif; ?>
