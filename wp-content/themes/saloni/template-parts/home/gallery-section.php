...
// FOOTデザインのギャラリーを取得（9件）
$foot_gallery = new WP_Query(array(
    'post_type' => 'gallery',
    'posts_per_page' => 9,
    'orderby' => 'date',
    'order' => 'DESC',
...
<div class="gallery-category-section">
    ...
    <div class="gallery-more-link">
        <a href="<?php echo esc_url($link_url); ?>" class="site-button-secondry">もっと見る</a>
    </div>
</div>
<?php
}
    ...
    <div class="container">
        <div class="section-content">
            ...
            <div class="section-content">
                ...
                <!-- FOOTデザイン -->
                <?php fascina_render_gallery_section($foot_gallery, 'FOOT Design', 'フットデザイン', home_url('/gallery_foot_design/'), $theme_uri); ?>
...
.gallery-more-link .site-button-secondry {
...
.gallery-more-link .site-button-secondry:hover {
    background: #d14a77;
}
