        ...
        <div class="wt-bnr-inr-entry">
            <div class="banner-title-outer text-center">
                <div class="banner-title-name">
                    <h2 class="wt-title">
                        <?php esc_html_e('404 - ページが見つかりません', 'saloni'); ?>
                    </h2>
                </div>
            </div>
            <!-- BREADCRUMB ROW -->
        ...
        <div class="row">
            <div class="col-lg-12 text-center">
                <div class="error-404-wrap">
                    ...
                    <h2>
                        <?php esc_html_e('ページが見つかりません', 'saloni'); ?>
                    </h2>
                    <p class="m-b30">
                        <?php esc_html_e('お探しのページは見つかりませんでした。', 'saloni'); ?>
                    </p>
                    <a href="<?php echo esc_url(home_url('/')); ?>" class="site-button site-btn-effect">
                        <?php esc_html_e('トップページへ戻る', 'saloni'); ?>
                    </a>
                </div>
            </div>
        </div>
