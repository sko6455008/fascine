...
<section class="hand-design-section fade-in-section">
    <h1 class="fascina-section-title">Hand Design</h1>
...
<section class="guest-design-section fade-in-section">
    <h1 class="fascina-section-title">Guest Design</h1>
    <div class="design-box">
        <?php
        $guest_args = array(
            'post_type' => 'gallery',
...
<section class="coupon-section fade-in-section">
    <h1 class="fascina-section-title">Coupon</h1>
    <div class="design-box">
        <?php
        $coupon_query = fascina_get_top_coupon_posts(12);
